                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div className=" text-center">
                          <ul>
                              ...
                              <li><a href="https://www.google.com/ktxbk.vn" target='_blank'><i className="fa fa-google-plus" aria-hidden="true"></i></a></li>
                              <li><a href="https://www.twitter.com/ktxbk.vn" target='_blank'><i className="fa fa-twitter" aria-hidden="true"></i></a></li>
